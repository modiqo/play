check: package-check
    ...
    uv run pyright scripts/lib/play/bootstrap.py scripts/lib/play/controller.py scripts/lib/play/continuations.py scripts/lib/play/executors.py scripts/lib/play/play_run.py scripts/lib/play/runtime_context.py scripts/lib/play/runtime_actions.py scripts/lib/play/elicitation.py scripts/lib/play/onboarding.py scripts/lib/play/public_owner.py scripts/lib/play/public_trends.py scripts/lib/play/run_output.py scripts/lib/play/publication.py scripts/lib/play/publication_gate.py scripts/lib/play/certificate.py scripts/bin/play-bootstrap scripts/bin/play-machine scripts/bin/play-run scripts/bin/play-onboarding scripts/bin/play-public-trends scripts/bin/play-public-owner scripts/bin/play-run-output scripts/bin/play-publication scripts/bin/play-publication-gate scripts/bin/play-certificate scripts/harness/install-all tests/controller/test_controller_runtime.py tests/awareness/test_public_trends.py tests/foundation/test_elicitation.py tests/foundation/test_onboarding.py tests/foundation/test_play_run.py tests/foundation/test_public_owner.py tests/foundation/test_run_output.py tests/foundation/test_publication.py tests/foundation/test_publication_gate.py tests/foundation/test_certificate.py tests/harness/test_bootstrap.py tests/harness/test_install_all.py
