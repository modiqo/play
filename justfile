check: package-check
    ...
    uv run pyright scripts/lib/play/identity.py tests/foundation/test_identity.py
    uv run pyright scripts/lib/play/python_environment.py scripts/lib/play/preflight.py scripts/harness/install-all tests/foundation/test_python_environment.py
    uv run pyright scripts/lib/play/guide.py scripts/bin/play-guide tests/foundation/test_guide.py
    uv run pyright scripts/lib/play/bootstrap.py scripts/lib/play/controller.py scripts/lib/play/continuations.py scripts/lib/play/executors.py scripts/lib/play/intercept.py scripts/lib/play/journal.py scripts/lib/play/journey.py scripts/lib/play/journey_capabilities.py scripts/lib/play/journey_model_telemetry.py scripts/lib/play/journey_scene.py scripts/lib/play/journey_story.py scripts/lib/play/journey_view.py scripts/lib/play/journey_view_catalog.py scripts/lib/play/journey_view_evidence.py scripts/lib/play/journey_world_model.py scripts/lib/play/journey_tutorial.py scripts/lib/play/journal_settings.py scripts/lib/play/milestones.py scripts/lib/play/play_run.py scripts/lib/play/recurrence.py scripts/lib/play/routing.py scripts/lib/play/runtime_context.py scripts/lib/play/runtime_actions.py scripts/lib/play/sidekick.py scripts/lib/play/elicitation.py scripts/lib/play/onboarding.py scripts/lib/play/public_owner.py scripts/lib/play/tag_hints.py scripts/lib/play/public_trends.py scripts/lib/play/run_output.py scripts/lib/play/publication.py scripts/lib/play/publication_gate.py scripts/lib/play/certificate.py scripts/bin/play-bootstrap scripts/bin/play-cheat-sheet scripts/bin/play-journal scripts/bin/play-journey scripts/bin/play-machine scripts/bin/play-recurring scripts/bin/play-routing scripts/bin/play-run scripts/bin/play-onboarding scripts/bin/play-public-trends scripts/bin/play-public-owner scripts/bin/play-tag-hints scripts/bin/play-run-output scripts/bin/play-publication scripts/bin/play-publication-gate scripts/bin/play-certificate scripts/harness/install-all tests/controller/test_controller_runtime.py tests/awareness/test_public_trends.py tests/foundation/test_cheat_sheet.py tests/foundation/test_elicitation.py tests/foundation/test_intercept.py tests/foundation/test_journal.py tests/foundation/test_journey.py tests/foundation/test_journey_model_telemetry.py tests/foundation/test_journey_scene.py tests/foundation/test_journey_story.py tests/foundation/test_milestones.py tests/foundation/test_onboarding.py tests/foundation/test_play_run.py tests/foundation/test_recurrence.py tests/foundation/test_routing.py tests/foundation/test_sidekick.py tests/foundation/test_public_owner.py tests/foundation/test_tag_hints.py tests/foundation/test_run_output.py tests/foundation/test_publication.py tests/foundation/test_publication_gate.py tests/foundation/test_certificate.py tests/harness/test_bootstrap.py tests/harness/test_install_all.py
    ...
    uv run pyright scripts/release/publish_play.py scripts/release/tag_play.py
