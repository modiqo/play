...
class BootstrapTest(unittest.TestCase):
    ...
    def test_plan_selects_top_k_and_skips_current_skill_providers(
        ...
        self.assertEqual("0.4.85", plan["play"]["target_version"])
    ...
    def test_local_codex_marketplace_is_not_sent_to_git_upgrade(self) -> None:
        ...
        steps = converge_play_marketplace(
            "codex", "/bin/codex", expected_version="0.4.85", runner=runner
        )
    ...
    def test_status_card_reports_independent_component_versions(self) -> None:
        ...
        self.assertIn("Play       0.4.74 → 0.4.85", rendered)
    ...
    @patch(
        ...
        return_value=[
            Step(
                "verify_play_plugin",
                "completed",
                "Play 0.4.85 is installed and enabled.",
                target="codex",
            )
        ],
    )
    ...
    def test_apply_existing_rote_updates_converges_installs_hooks_and_verifies(
        ...
        self.assertEqual(
            "0.4.85", _converge_marketplace.call_args.kwargs["expected_version"]
        )
